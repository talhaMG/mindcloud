...
class Business_tool_fm_dcvm extends MY_Controller {
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->dt_params['dt_headings'] = "tool_builder_id,tool_builder_user_id,tool_builder_currency,tool_builder_net_profit,cash,tool_builder_approval_status,tool_builder_status";
