<?
class Model_course_category extends MY_Model {
    /**
     * TKD course_category MODEL
     *
     * @package     course_category Model
     * 
     * @version     2.0
     * @since       2014 / Amazingly corrupt models Corporation Inc.
     */

    protected $_table    = 'course_category';
    ...
    function __construct()
    {
        ...
        $this->pagination_params['joins'][] = array(
                                                    "table"=>"category" , 
                                                    "joint"=>"category_id = cp_category_id", 
                                                );
        parent::__construct();
    ...
    //     $data = $this->model_course_category->find_one($param);
    //     return $data;
    // }
    ...
    //         "type" => "left"
    //         );
    //     $data = $this->model_course_category->find_all($param);
    //     }
    //     return $data;
    // }
