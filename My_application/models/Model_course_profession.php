<?
class Model_course_profession extends MY_Model {
    /**
     * TKD course_profession MODEL
     *
     * @package     course_profession Model
     * 
     * @version     2.0
     * @since       2014 / Amazingly corrupt models Corporation Inc.
     */

    protected $_table    = 'course_profession';
    ...
    function __construct()
    {
        ...
        $this->pagination_params['joins'][] = array(
                                                    "table"=>"profession" , 
                                                    "joint"=>"profession_id = cp_profession_id", 
                                                );
        parent::__construct();
    ...
    //     $data = $this->model_course_profession->find_one($param);
    //     return $data;
    // }
    ...
    //     $param['joins'][] = array(
    //         "table"=>"category" , 
    //         "joint"=>"category.category_id = course_profession.cp_category_id",
    //         "type" => "left"
    //         );
    //     // category_depart_id
    //     $param['joins'][] = array(
    ...
    //         "type" => "left"
    //         );
    //     $data = $this->model_course_profession->find_all($param);
    //     }
    //     return $data;
    // }
    ...
    public function get_fields( $specific_field = "" )
    {
        ...
        $fields = array(
          ...
          'cp_id' => array(
              ...
              'cp_profession_id' => array(
                     'table'   => $this->_table,
                     'name'   => 'cp_profession_id',
                     'label'   => 'id #',
                     'type'   => 'hidden',
                     'type_dt'   => 'text',
                     'attributes'   => array(),
