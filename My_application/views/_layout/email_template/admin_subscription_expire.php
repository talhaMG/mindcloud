...
header span, header img { display: block; margin: 0 13em; }
		...
		<article>
			...
			<table class="inventory">
				...
				<tbody>
					...
					<br>
					<br>
					One Subscription has expired.Details are as below.
					<br>
					<br>
					
					<ul style="font-family: initial;font-size: 17px;">
						<li>Subscription ID # - <?=$expired_subscriptions['advertisment_id']?></li>
						<li>User ID # - <?=$expired_subscriptions['advertisment_user_id']?></li>
						<li>Package Title # - <?=$expired_subscriptions['advertisment_package_name']?></li>
						<li>Subscription Expired # - <?=csl_date($expired_subscriptions['advertisment_package_expire'],"F d,Y")?></li>
					</ul>
