...
@page { margin: 0; }
	...
	<body>
		<header>
			...
			<address style="    font-size: 14px;width: 100px; float: left;">
				<p><?=$letter_head['name']?></p>
				<p><?=$letter_head['address']?></p>
				<p><?=$letter_head['phone']?></p>
			</address>
			<span style="    margin: 0 0 1em 1em;max-height: 25%; max-width: 40%;"><img alt="" src="<?=$letter_head['logo']?>"></span>
		<br><br>
		<br>
		</header>
		<article>
			...
			<table class="meta" style="font-size: 12px">
				<tr>
					<th><span >Invoice #</span></th>
					<td><span ><?=$invoice_info['no']?></span></td>
				</tr>
				<tr>
					<th><span >Date</span></th>
					<td><span ><?=$invoice_info['date']?></span></td>
				</tr>
				<tr>
					<th><span >Amount</span></th>
					<td><span id="prefix" ><?=$invoice_info['invoice_amount']?></span></td>
				</tr>
			...
			<table class="inventory">
				...
				<tbody>
					...
					<br>
					<br>
						<?=$customer_info['name']?> successfully subscribe for <span class="content">"<?=$package_info['title']?>"</span> package for 
						<?=$invoice_info['invoice_amount']?> on 
					<?=csl_date($package_info['startedon'], "F d,Y")?>  which expires on
					<br>
