        ...
        <tbody>
            ...
            <tr id="row-<?=$value[$pk_id]?>">
                ...
                <td>
                    ...
                    <a href='javascript:void(0);' class="btn btn-danger btn-xs delete_this" data-url='<?=l('account/'.$class."/ajax-delete")?>' data-pkid='<?=$value[$pk_id]?>'><span class="glyphicon glyphicon-trash"></span></a>
                </td>
            </tr>
            <?php } ?>
