          ...
          <div class="tab-pane active" id="tab_0">
            ...
            // Images only in edit mode.  
              ...
              <div class="tab-pane" id="tab_5">
                  ...
                  <div class="portlet-title">
                    <div class="caption">
                      <i class="fa fa-shopping-cart"></i><?=humanize('Expert Image')?>
                  ...
                  <div class="portlet-body form">
                    ...
                    <!-- BEGIN FORM-->
                    <? $this->load->view("admin/expert/image");?>
                    <!-- END FORM-->
                  </div>
                  <!-- END VALIDATION STATES-->
                </div>
...
$(function() {
  var uploader = new plupload.Uploader({
    ...
    url: BASE_URL+'admin/expert/ajax-uploadtoserver?id=<?=$form_data['expert']['expert_id']?>',
    chunk_size: '4024gb',
    max_retries: 3,
    ...
    preinit : {
        UploadComplete: function(up, files) {
          ...
          AdminToastr.success('Expert Uploaded');
