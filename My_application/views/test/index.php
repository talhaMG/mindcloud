<div class="container">
            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="#">Amazon Pay PHP SDK Sample: One-Time Payment Checkout</a>
                    </div>
           ...
           <?php echo $amazonpay_config['client_id'];?>
            ...
            window.onAmazonPaymentsReady = function () {
                ...
                OffAmazonPayments.Button("AmazonPayButton", "<?php echo $amazonpay_config['merchant_id']; ?>", {
                    ...
                    authorization: function() {
                        ...
                        authRequest = amazon.Login.authorize(loginOptions, "<?=l('test/handle_login')?>");
                    },
