...
.getstrtpg-lst ul li.nx7 a:before {
    content: '';
    position: absolute;
    left: 20px;
    width: 12px;
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-3 col-xs-12 col-sm-3">
        <div class="getstrtpg-lst">
          <ul>
            ...
            <li class="nx4"><i class="fa fa-check" aria-hidden="true"></i><a href="<?=l('calculator_steps/steptwentyone').'?query-id='.$queryid.'&key='.$key?>')?>">Real Estate</a></li>

            <li class="nx5"><i class="fa fa-check" aria-hidden="true"></i><a href="<?=l('calculator_steps/steptwentythree').'?query-id='.$queryid.'&key='.$key?>">Declarations</a></li>

            <li class="nx6"><i class="fa fa-check" aria-hidden="true"></i><a href="<?=l('calculator_steps/steptwentyseven').'?query-id='.$queryid.'&key='.$key?>">Demographic Info</a></li>

            <li class="active nx7"><i class="fa fa-check" aria-hidden="true"></i><a href="<?=l('calculator_steps/stepforty').'?query-id='.$queryid.'&key='.$key?>">Additional Questions</a></li>
          </ul>
        </div>
        <div class="trm-ustxt">
      ...
      <div class="col-md-9 col-xs-12 col-sm-9">
        ...
        <div class="tel-onsesn">
          <h2>Let's review your application and get ready for submission!</h2>

          <a href="<?=l('calculator_steps/stepfortyfour').'?query-id='.$queryid.'&key='.$key?>">Start this section</a>
        </div>
        </div>
        <div class="col-md-4 col-xs-12 col-sm-4">
          <div class="brwer-img">
          <span><img src="<?=i('')?>img52.png" class="img-responsive" alt="img"></span>
          </div>
        </div>
        </div>
