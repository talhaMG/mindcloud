    ...
    <div class="row">
      <div class="col-md-3 col-xs-12 col-sm-3">
        <div class="getstrtpg-lst">
          <ul>
            ...
            <li class="active tw"><a href="<?=l('calculator_steps/stepseventeen').'?query-id='.$queryid.'&key='.$key?>">Assets</a></li>
      ...
      <div class="col-md-9 col-xs-12 col-sm-9">
        ...
        <div class="tel-onsesn">
          <h2>Tell us about your assets 
and accounts</h2>
          <p>We'll gather details about the assets and accounts you'll use for your down payment and closing costs. To make it easier, link your accounts to import this information automatically.</p>
          <a href="<?=l('calculator_steps/ajax_stepseventeen').'?query-id='.$queryid.'&key='.$key?>">Start this section</a>
        </div>
        </div>
        <div class="col-md-4 col-xs-12 col-sm-4">
          <div class="brwer-img">
          <span><img src="<?=i('')?>img51.png" class="img-responsive" alt="img"></span>
          </div>
        </div>
        </div>
