...
<i class="fa fa-check" aria-hidden="true"></i><a href="<?=l('calculator_steps/steptwentyseven').'?query-id='.$queryid.'&key='.$key?>">Demographic Info</a></li>
            ...
            <li class="active"><a href="<?=l('calculator_steps/stepthirtyeight').'?query-id='.$queryid.'&key='.$key?>">Additional Questions</a></li>
          </ul>
        </div>
        <div class="trm-ustxt">
      ...
      <div class="col-md-9 col-xs-12 col-sm-9">
        ...
        <div class="gt-frmone">
          <a href="<?=l('calculator_steps/stepthirtyseven').'?query-id='.$queryid.'&key='.$key?>" class="pull-left"><i class="fa fa-angle-left" aria-hidden="true"></i>Back</a>
     ...
     <!--        <div class="row">
            ...
            <div class="row">
              <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="cntnu-btn">
                  <a href="<?=l('calculator_steps/stepfortynine').'?query-id='.$queryid.'&key='.$key?>">Continue</a>
                </div>
              </div>
            </div>
          </div>
