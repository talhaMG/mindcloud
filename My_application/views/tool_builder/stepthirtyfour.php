...
<i class="fa fa-check" aria-hidden="true"></i><a href="<?=l('calculator_steps/steptwentyseven').'?query-id='.$queryid.'&key='.$key?>">Demographic Info</a></li>
            ...
            <li class="active">
<a href="<?=l('calculator_steps/stepthirtyfour').'?query-id='.$queryid.'&key='.$key?>">Additional Questions</a></li>
          </ul> 
        </div>
        <div class="trm-ustxt">
      ...
      <div class="col-md-9 col-xs-12 col-sm-9">
        ...
        <div class="gt-frmone">
          <a href="<?=l('calculator_steps/stepthirtythree').'?query-id='.$queryid.'&key='.$key?>" class="pull-left"><i class="fa fa-angle-left" aria-hidden="true"></i>Back</a>
        ...
        <div class="row">
          <div class="col-md-offset-3 col-md-6 col-md-offset-3 col-xs-12 col-sm-12">
            <div class="few-prvd ask-stp">
              <span class="shl">Have you owned property in the last three years?</span>
            </div>
        ...
        //debug($loan);
        ?> 
       <form id="form-send_us" action="<?=l('calculator_steps/ajax_stepthirtyfour')?>">
                  
                  <input type="hidden" name="id" value="<?=$queryid?>">
                  <input type="hidden" name="key" value="<?=$key?>">

              <div class="crcl-rdio">
                <p>Owned property in the last three years?</p>

         <?php if ($loan['loan_own_property']=='Yes'){ ?>   

  <label class="count">Yes
  <input type="radio"  name="loan[loan_own_property]" value="Yes" checked>
  <span class="checkmark"></span>
</label>
    <?php } else{?> 
  <label class="count">Yes
  <input type="radio"  name="loan[loan_own_property]" value="Yes">
  <span class="checkmark"></span>
</label>
<?php } ?>


         <?php if ($loan['loan_own_property']=='No'){ ?>   
<label class="count">No
  <input type="radio"   name="loan[loan_own_property]" value="No" checked> 
  <span class="checkmark"></span>
</label>
    <?php } else{?> 
<label class="count">No
  <input type="radio"   name="loan[loan_own_property]" value="No"> 
  <span class="checkmark"></span>
</label>
