...
<i class="fa fa-check" aria-hidden="true"></i><a href="<?=l('calculator_steps/steptwentythree').'?query-id='.$queryid.'&key='.$key?>">Declarations</a></li>
            ...
            <li class="active"><a href="<?=l('calculator_steps/stepthirtyone').'?query-id='.$queryid.'&key='.$key?>">Demographic Info</a></li>
      ...
      <div class="col-md-9 col-xs-12 col-sm-9">
        ...
        <div class="gt-frmone">
          <a href="<?=l('calculator_steps/stepthirty').'?query-id='.$queryid.'&key='.$key?>" class="pull-left"><i class="fa fa-angle-left" aria-hidden="true"></i>Back</a>
          ...
          <div class="col-md-offset-3 col-md-6 col-md-offset-3 col-xs-12 col-sm-12">
            ...
            <div class="row">
              <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="cntnu-btn">
                  <a href="<?=l('calculator_steps/ajax_stepthirtyone').'?query-id='.$queryid.'&key='.$key?>">Continue</a>
                </div>
              </div>
            </div>
          </div>
