...
<i class="fa fa-check" aria-hidden="true"></i><a href="<?=l('calculator_steps/steptwentyseven').'?query-id='.$queryid.'&key='.$key?>">Demographic Info</a></li>
            ...
            <li class="active"><a href="<?=l('calculator_steps/stepthirtysix').'?query-id='.$queryid.'&key='.$key?>">Additional Questions</a></li>
          </ul>
        </div>
        <div class="trm-ustxt">
      ...
      <div class="col-md-9 col-xs-12 col-sm-9">
        ...
        <div class="gt-frmone">
          <a href="<?=l('calculator_steps/stepthirtyfour').'?query-id='.$queryid.'&key='.$key?>" class="pull-left"><i class="fa fa-angle-left" aria-hidden="true"></i>Back</a>
        ...
        <div class="row">
          <div class="col-md-offset-3 col-md-6 col-md-offset-3 col-xs-12 col-sm-12">
            <div class="few-prvd ask-stp">
              <span class="shl">What is the highest level of education you 
have completed?</span>
            </div>
      ...
      <?   
        ...
        ?> 
      <form id="form-send_us" action="<?=l('calculator_steps/ajax_stepthirtysix')?>">
              ...
              <select class="cvn" name="loan[loan_education]" required="">
              <?php if (!empty($loan['loan_education'])){ ?>    
               <option value="<?=$loan['loan_education']?>"><?=$loan['loan_education']?></option>
              <?php } else{?>   
