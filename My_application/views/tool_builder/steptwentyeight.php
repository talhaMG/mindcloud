...
<i class="fa fa-check" aria-hidden="true"></i><a href="<?=l('calculator_steps/steptwentythree').'?query-id='.$queryid.'&key='.$key?>">Declarations</a></li>
            ...
            <li class="active"><a href="<?=l('calculator_steps/steptwentyeight').'?query-id='.$queryid.'&key='.$key?>">Demographic Info</a></li>
      ...
      <div class="col-md-9 col-xs-12 col-sm-9">
        ...
        <div class="gt-frmone">
          <a href="<?=l('calculator_steps/steptwentyseven').'?query-id='.$queryid.'&key='.$key?>" class="pull-left"><i class="fa fa-angle-left" aria-hidden="true"></i>Back</a>
        ...
        <div class="row">
          <div class="col-md-offset-3 col-md-6 col-md-offset-3 col-xs-12 col-sm-12">
            ...
            <div class="gtng-1 step-78">
              <form id="form-send_us" action="<?=l('calculator_steps/ajax_steptwentyeight')?>">

                  <input type="hidden" name="id" value="<?=$queryid?>">
                  <input type="hidden" name="key" value="<?=$key?>">
              <span class="abd"> <?=$loan['loan_fname']?>, what is your sex?</span>
              <span class="anthr">Please select all options that apply to you.</span>
              <div class="mlng-adrs step-77">
                <p>What is your sex?</p>


<?php if ($loan['loan_sex']=='Female'){ ?> 
  <label class="mail">Female
  <input type="radio" name="loan[loan_sex]" value="Female" checked>
  <span class="checkmark"></span>
</label>
  <?php } else{?> 

  <label class="mail">Female
  <input type="radio" name="loan[loan_sex]" value="Female">
  <span class="checkmark"></span>
</label>
  <?php } ?>  


<?php if ($loan['loan_sex']=='Male'){ ?> 
<label class="mail">Male
  <input type="radio" name="loan[loan_sex]" value="Male" checked>
  <span class="checkmark"></span>
</label>

  <?php } else{?> 
<label class="mail">Male
  <input type="radio" name="loan[loan_sex]" value="Male">
  <span class="checkmark"></span>
</label>
...
<?php if ($loan['loan_sex']=='Do not wish to provide'){ ?>   
<label class="mail">Do not wish to provide
  <input type="radio" name="loan[loan_sex]" value="Do not wish to provide" checked>
  <span class="checkmark"></span>
</label>
...
<label class="mail">Do not wish to provide
  <input type="radio" name="loan[loan_sex]" value="Do not wish to provide">
  <span class="checkmark"></span>
</label>
