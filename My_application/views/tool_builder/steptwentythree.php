    ...
    <div class="row">
      <div class="col-md-3 col-xs-12 col-sm-3">
        <div class="getstrtpg-lst">
          <ul>
            ...
            <li class="active"><a href="<?=l('calculator_steps/steptwentythree').'?query-id='.$queryid.'&key='.$key?>">Declarations</a></li>
      ...
      <div class="col-md-9 col-xs-12 col-sm-9">
        ...
        <div class="tel-onsesn">
          <h2>Next, we'll ask you about any 
financial circumstances you 
need to disclose.</h2>
          <p>These questions will help us understand more about your financial situation when we review your application.</p>
          <a href="<?=l('calculator_steps/ajax_steptwentythree').'?query-id='.$queryid.'&key='.$key?>">Start this section</a>
        </div>
        </div>
        <div class="col-md-4 col-xs-12 col-sm-4">
          <div class="brwer-img">
          <span><img src="<?=i('')?>img62.png" class="img-responsive" alt="img"></span>
          </div>
        </div>
        </div>
